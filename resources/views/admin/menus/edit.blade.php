    ...
    <div class="py-12 ">
        ...
        <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" value="{{ $menu->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="price" value="{{ $menu->price }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
            </div>
                ...
                <div>
                    <select name="categories[]" multiple class="form-multiselect block w-full">
                        @foreach ($categories as $category)
                            <option @selected($menu->categories->contains($category))
                                value="{{ $category->id }}">
                                {{ $category->name }}
                            </option>
                        @endforeach
